...
using Amazon.S3;
using Applcation.Services.CourceService.AuthService;
using Applcation.Services.CourceService.CategoryService;
using Applcation.Services.CourceService.ChapterService;
...
using Application.Services.LessonService.AuthService;
using Application.Services.LessonService.CategoryService;
using Application.Services.LessonService.ChapterService;
using Application.Services.LessonService.CourceService;
using Application.Services.LessonService.CourceService.AuthService;
using Application.Services.LessonService.CourceService.CategoryService;
using Application.Services.LessonService.CourceService.ChapterService;
using Application.Services.LessonService.FavoritService;
